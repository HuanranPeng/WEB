...
export const threeJsDemo: Demo = {
  ...
  projects: [
    ...
    //   description: 'A 3D physics sandbox using Three.js and Cannon.js. Throw objects around and watch them interact with realistic physics.',
    //   imageUrl: '/images/playground-physics.png',
