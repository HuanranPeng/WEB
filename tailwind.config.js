  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        // Body scale
        'body-xxl': ['30px', { lineHeight: '120%', letterSpacing: '-0.30px', fontWeight: '300' }],
        'body-xl': ['24px', { lineHeight: '150%', letterSpacing: '-0.24px', fontWeight: '300' }],
        'body-lg': ['20px', { lineHeight: '150%', letterSpacing: '-0.20px', fontWeight: '300' }],
        'body-md': ['18px', { lineHeight: '150%', letterSpacing: '-0.18px', fontWeight: '300' }],
        'body-sm': ['16px', { lineHeight: '150%', fontWeight: '300' }],
        'body-xs': ['15px', { lineHeight: '150%', fontWeight: '300' }],
        'body-caption': ['14px', { lineHeight: '164%', fontWeight: '300' }],
      },
      letterSpacing: {
        tighter: '-1.92px',
        tight: '-1.6px',
